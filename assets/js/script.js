...
var questionCache = [
  ...
  {
    question: "_______ is the process of cleaning, oraganizing and simplifying code.",
    choices: ["Code Refactoring", "Commenting", "Commiting", "Programming"],
    answer: "Code Refactoring",
  },
  {
    question: "Which is one of the three basic programming languages of the web?",
  ...
  },
  {
    ...
    choices: ["JSON.stringify(parse)", "JSON.stringifiy()", "JSON.parse()", "None of the Above"],
    answer: "JSON.parse()",
  },
  {
    question: "What does JSON stand for?",
    choices: ["JavaScript Object Notation", "JQuery Object Notation", "Java Object Negation", "JQuery Object Notation"],
    answer: "JavaScript Object Notation",
  },
  {
    question: "What symbol indicates you are using JQuery?",
    choices: ["#", "%", "!", "$"],
    answer: "$",
  },
  {
